...
const Favorites = () => {
  ...
  // Current weather condition & night check from context
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-slate-950 text-white">
      ...
      {/* 2. Dynamic Rain Canvas Overlay Layer (Speed = 1) */}
      <WeatherRainOverlay
        speedMultiplier={0.5}
        weatherCondition={currentWeatherCondition}
      />

      {/* 3. Main Content UI Layer */}
      <div className="relative z-10 max-w-5xl mx-auto px-4 py-8 space-y-6">
        ...
        {favorites.length === 0 ? (
          <div className="p-12 text-center rounded-3xl bg-slate-900/40 backdrop-blur-md border border-slate-800">
